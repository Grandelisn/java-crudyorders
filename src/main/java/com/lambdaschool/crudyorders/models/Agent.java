...
public class Agent {
    ...
    //The country (String) where the agent is located
    ...
    /*
        ...
        @param country              The country (String) where the agent is located
    ...
    //@params agentname The new name (String) of the agent
    ...
    /*
        ...
        @params commission The new commission rate (double) of the agent.
    */
    ...
    //Getter for country
    //@return The country (String) where the agent is located
    public String getCountry() {
        return country;
    }

    //Setter for country
    //@param country The country (String) where the agent located
    public void setCountry(String country) {
        this.country = country;
    }

    //Getter for phone
    //@return The phone (String) of the agent. No predefined format.
